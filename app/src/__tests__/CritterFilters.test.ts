...
it('sorting test', () => {
    ...
    const northResultAll = filterCritters(0, hemisphere.north, critterSet1, false, sortType.alphaAsc, new Date('2020-07-13T10:00:00.0000'));
    console.log(northResultAll.available.bugs);
